...
Route::group(array('before' => 'sentry'), function()
{
    ...
    // Case notes
    Route::get('case_note/{contact_id}/create', array('as' => 'case_note.create',  'uses' => 'CaseNoteController@create'));
    Route::post('case_note/{id}/store',         array('as' => 'case_note.store',   'uses' => 'CaseNoteController@store'));
    Route::get('case_note/{id}',                array('as' => 'case_note.show',    'uses' => 'CaseNoteController@show'));
    Route::get('case_note/{id}/edit',           array('as' => 'case_note.edit',    'uses' => 'CaseNoteController@edit'));
    Route::post('case_note/{id}/update',        array('as' => 'case_note.update',  'uses' => 'CaseNoteController@update'));
    Route::delete('case_note/{id}/destroy',     array('as' => 'case_note.destroy', 'uses' => 'CaseNoteController@destroy'));
